...
public class WSClient {
	...
	public static void main(String[] args) {
		final WSClient instance = new WSClient();
		instance.startClient(args);
	}
	...
	private void startClient(String[] args) {
		...
		factory.setAddress("http://localhost:9090/helloService");
		HelloService client = factory.create(HelloService.class);
