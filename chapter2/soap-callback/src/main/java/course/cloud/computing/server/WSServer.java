...
import course.cloud.computing.service.SOAPServiceImpl;
...
public class WSServer {
	...
	public static void main(String[] args) {
		...
		instance.startServer(servername, port);
	}
	...
	private void startServer(String serverName, int port) {
		...
		// Note that the factory.create is a blocking call and will exit only
		// with TERM
		// signal
		try {
			...
			factory.setServiceClass(course.cloud.computing.service.SOAPServiceImpl.class);
